...
int main(int, char**)
{
	...
	std::unique_ptr<Camera> camera = std::make_unique<Camera>(glm::vec3{ 5, 5, 5 }, glm::vec3{ 0, 0, -10 }, glm::vec3{ 0, 1, 0 }, 90.0f, glm::ivec2{ framebuffer->colorbuffer.width, framebuffer->colorbuffer.height }, 0.6f, focalLength);	
	//Render Scene
